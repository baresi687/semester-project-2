...
window.addEventListener('click', function (event) {
  if (event.target.closest('#hamburger-btn') && !hamburgerMenu.classList.contains('-translate-x-0')) {
  ...
  } else if (hamburgerMenu.classList.contains('-translate-x-0') && !event.target.closest('#menu')) {
    hamburgerMenu.classList.remove('-translate-x-0');
    hamburgerBtn.querySelector('svg').classList.remove('rotate-90');
    hamburgerBtn
      .querySelector('path')
      .setAttribute('d', 'M0 24.35H24V20.35H0V24.35ZM0 14.35H24V10.35H0V14.35ZM0 0.349976V4.34998H24V0.349976H0Z');
  }
});
